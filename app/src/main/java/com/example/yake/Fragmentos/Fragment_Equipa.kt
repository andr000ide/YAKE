...
class Fragment_Equipa : androidx.fragment.app.Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        membrosArr.add(MembroEquipa(nome = "Célia Nunes", linkedin = "https://www.linkedin.com/in/c%C3%A9lia-nunes-7523a968/", mail = "celian@ubi.pt",   github = "",web = "http://www.mat.ubi.pt/~celia/",imagemUrl = R.drawable.celia, cargo = getString(R.string.cargo_resea_profa)))
        ...
        view.rec_view_nos.apply {
            ...
            layoutManager = androidx.recyclerview.widget.LinearLayoutManager(activity)
            // set the custom adapter to the RecyclerView
            adapter = EquipaAdapter(membrosArr2, context!!)
        }
