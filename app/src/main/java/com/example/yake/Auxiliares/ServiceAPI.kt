...
interface ServiceAPI {
    ...
    fun search_keywords_url(@Query("url") url : String, @Query("max_ngram_size") max_ngram_size : String, @Query("number_of_keywords") number_of_keywords : String) : Call<Example_Yake>
    ...
    fun search_keywords_texto(@Field("content") content : String, @Query("max_ngram_size") max_ngram_size : String, @Query("number_of_keywords") number_of_keywords : String) : Call<Example_Yake>
}